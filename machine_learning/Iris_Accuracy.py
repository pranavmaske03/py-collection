...
def main():
    ...
    print("Accuracy of classification algorighm with Decision Tree classifier is",Accuracy*100,"%")

    Accuracy = MarvellousCalculateAccuracyKNeighbor()
    print("Accuracy of classification algorighm with K Neighbor classifier is",Accuracy*100,"%")
